        ...
        <div class="container-fluid row">
          ...
          <ul class="nav nav-pills col-8" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="pills-vuelos-tab" data-bs-toggle="pill"
                data-bs-target="#pills-vuelos" type="button" role="tab" aria-controls="pills-vuelos"
                aria-selected="true">Vuelos</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-autos-tab" data-bs-toggle="pill"
                data-bs-target="#pills-autos" type="button" role="tab" aria-controls="pills-autos"
          ...
          <div class="collapse navbar-collapse col-2" id="navbarNavDarkDropdown">
            <ul class="navbar-nav">
              <button type="button" id="imageTurista" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <span class="badge bg-primary m-1">Turista</span>
          </div>
        </div>
      </nav>

      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-vuelos" role="tabpanel" aria-labelledby="pills-vuelos-tab">
          <table class="table table-striped mt-4" id="tablaVuelos">
            ...
            <tbody id="tbodyVuelos"></tbody>
          </table>
        </div>

        <div class="tab-pane fade" id="pills-autos" role="tabpanel" aria-labelledby="pills-autos-tab">
          <table class="table table-striped mt-4" id="tablaAutos">
            <thead class="table-dark">
              <tr>
                <th scope="col">#</th>
                <th scope="col">Nombre de la agencia</th>
